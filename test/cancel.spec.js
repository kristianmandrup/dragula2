...
test('cancel does not throw when not dragging', t => {
...
test('when dragging and cancel gets called, nothing happens', t => {
...
test('when dragging and cancel gets called, cancel event is emitted', t => {
  var div = document.createElement('div')
  var item = document.createElement('div')
  var drake = dragula([div])
  div.appendChild(item)
...
test('when dragging a copy and cancel gets called, default does not revert', t => {
  var div = document.createElement('div')
...
test('when dragging a copy and cancel gets called, revert is executed', t => {
  var div = document.createElement('div')
  var div2 = document.createElement('div')
  var item = document.createElement('div')
  var drake = dragula([div, div2])
